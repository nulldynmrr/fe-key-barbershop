    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FDFBF9] bg-pattern relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full max-w-md bg-white p-8 sm:p-12 rounded-xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="font-serif text-[#4C2222] text-lg tracking-[0.15em] uppercase mb-1">Key Barber</h1>
          <p className="text-[9px] tracking-[0.25em] text-[#857372] font-normal uppercase">Established in Tradition</p>
        </div>

        {/* Create Section */}
        <div className="text-center mb-8">
          <h2 className="font-serif text-2xl text-gray-900 mb-3">Create Your Account</h2>
          <p className="font-lato text-sm text-[#524342] leading-relaxed px-4">
        ...
        <div className="relative flex items-center mb-6">
          ...
          <span className="flex-shrink-0 mx-4 text-[10px] text-[#857372] font-normal tracking-wider">OR</span>
          <div className="flex-grow border-t border-[#857372]"></div>
        </div>
        ...
        <form>
          <div className="mb-6">
            ...
            <input type="text" placeholder="Enter your full name" className="w-full pb-2 border-b border-gray-200 focus:border-[#4A2C2A] focus:outline-none transition-colors text-sm placeholder:text-gray-300" />
          </div>

          <div className="mb-6">
            <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-2">Email Address</label>
            <input type="email" placeholder="Enter your email" className="w-full pb-2 border-b border-gray-200 focus:border-[#4A2C2A] focus:outline-none transition-colors text-sm placeholder:text-gray-300" />
          </div>
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-2">
              <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-widest">Confirm Password</label>
            </div>
            <input
              type="password"
          ...
          <button type="submit" className="w-full bg-[#4C2222] hover:bg-[#3A2220] text-white py-3.5 rounded-[4px] text-xs font-boldtracking-[0.2em] uppercase transition-colors shadow-md">
            Sign In
          </button>
        </form>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-[9px] text-[#D7C2C0] leading-[1.6] font-normal italic max-w-[280px] mx-auto">By signing in, you agree to our Terms of Service and Privacy Policy concerning AI processing.</p>
        </div>
      </div>

      {/* Absolute Footer */}
      <div className="absolute bottom-6 w-full text-center text-[10px] font-bold tracking-[0.2em] text-[#A89F95] z-0">© 2026 KEY BARBER</div>
    </div>
  );
}
