...
export default function AILoadingModal({ isOpen, onClose, onComplete, disableAutoProgress = false, previewStep = 1 }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="relative w-full max-w-md rounded-3xl border border-[#d8c8bc] bg-[#f7f1ea] p-8 shadow-2xl">
        {/* Close Button */}
        ...
        <div className="mb-8 flex justify-center ">
          <div className="flex h-32 w-32 m-5 bg-[#934B19]/5 shadow-[#934B19] shadow-2xl/10 items-center justify-center rounded-3xl border-4 border-[#422522] ">
