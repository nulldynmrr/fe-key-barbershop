        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {barbers.length > 0 ? (
            barbers.map((barber) => (
              <div
                key={barber.id}
                className="bg-white rounded-xl overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.03)] border border-[#f0e2d9] transition-all hover:shadow-[0_8px_20px_rgba(0,0,0,0.06)] hover:-translate-y-1"
              >
                ...
                <div className="p-4 space-y-3 bg-white">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p
                        className="text-sm font-medium text-[#2b1d19]"
                        style={{ fontFamily: "var(--font-plus-jakarta)" }}
                      >
                        {barber.spesialisasi || "Umum"}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
            ...
            <div className="col-span-full flex flex-col items-center justify-center py-16 text-center">
              ...
              <h3 className="text-lg font-bold text-[#2b1d19] mb-1">
                Belum Ada Kapster
              </h3>
              <p className="text-sm text-gray-500 max-w-md">
                Data tim barber Anda masih kosong. Tambahkan kapster pertama
                Anda untuk menampilkannya di sini.
              </p>
              <button
                onClick={openAddModal}
